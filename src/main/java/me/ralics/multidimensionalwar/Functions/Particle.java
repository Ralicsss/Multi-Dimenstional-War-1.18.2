...
public class Particle extends BukkitRunnable {
    ...
    public void run(){
        if (EventManager.portals == true) {
            ...
            org.bukkit.Particle.DustOptions pepe = new org.bukkit.Particle.DustOptions(Color.RED, 100);
            Location overworldloc = new Location(overworld, 90, 75, 183.5);
            ...
            overworld.spawnParticle(org.bukkit.Particle.REDSTONE, overworldloc, 200, 0, 6, 3.5, 999999999, pepe);
